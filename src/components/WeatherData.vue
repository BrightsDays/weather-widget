<template>
  <div class="weather">
    <div class="weather__main">
      <img class="weather__icon weather__icon--big" v-if="icon" :src="`http://openweathermap.org/img/wn/${icon}.png`" alt="weather status"/>
    ...
    <div class="weather__info">
      <span class="weather__sensor">
        <svg class="weather__icon weather__icon--small" :style="`transform: rotate(${windDeg}deg)`"
             data-v-47880d39="" viewBox="0 0 1000 1000" xml:space="preserve"><g data-v-47880d39="" fill="#48484a"><path data-v-47880d39="" d="M510.5,749.6c-14.9-9.9-38.1-9.9-53.1,1.7l-262,207.3c-14.9,11.6-21.6,6.6-14.9-11.6L474,48.1c5-16.6,14.9-18.2,21.6,0l325,898.7c6.6,16.6-1.7,23.2-14.9,11.6L510.5,749.6z"></path><path
            data-v-47880d39=""
      ...
      <span class="weather__sensor">
        <svg class="weather__icon weather__icon--small" data-v-7bdd0738="" data-v-3208ab85="" width="16pt" height="16pt"
             viewBox="0 0 96 96">
